...
..\bin\release\bin\ResText extract ..\bin\release\bin\TortoiseProcLang.dll ..\bin\release\bin\TortoiseShellLang.dll -useheaderfile TortoisePotHeader.txt TortoiseSI.pot
